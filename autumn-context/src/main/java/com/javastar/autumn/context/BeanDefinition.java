package com.javastar.autumn.context;

import com.javastar.autumn.exception.BeanCreationException;
...
public class BeanDefinition implements Comparable<BeanDefinition>{
    ...
    public Object getRequiredInstance() {
        if (this.instance == null) {
            throw new BeanCreationException(String.format("Instance of bean with name '%s' and type '%s' is not " +
                    "instantiated during current stage.", this.name, this.beanClass.getName()));
        }
        return this.instance;
    }
    ...
    public String toString() {
        return "BeanDefinition [name=" + this.name + ", beanClass=" + this.beanClass.getName() + ", factory=" + getCreateDetail() + ", init-method="
